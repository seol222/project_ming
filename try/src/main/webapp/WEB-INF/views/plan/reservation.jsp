    ...
    calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      select: function(arg) {
        ...
        if (title) {
    	  ...
    	  let savetitle  = allEvent[allEvent.length-1]._def.title;
    	  let saveallDay =  allEvent[allEvent.length-1]._def.allDay;
    	  let savestart = allEvent[allEvent.length-1]._instance.range.start;
    	  let saveend = allEvent[allEvent.length-1]._instance.range.end;
    	  let savbackgroundColor = allEvent[allEvent.length-1].backgroundColor;
    	  let savtextColor = allEvent[allEvent.length-1].textColor;
    	  let savedata = {
    			  title : savetitle,
    			  allDay : saveallDay,
    			  start1 : savestart,
